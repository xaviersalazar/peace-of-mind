export const INFRARED_SAUNA_DATA = {
  BENEFITS: [
    {
      ...
      text: [
        ...
        "Rejuvenating LED light therapy can be used pain management such as joint and back pain, sore or torn muscles, sprains, arthritis, post-surgical scars, burns, wounds and more. When used with infrared technology, light therapy (phototherapy) is one of the most effective and non-invasive ways to repair the body.",
        "Light therapy is also used to relieve Seasonal Affective Disorder (SAD). SAD effects individuals when the lack of sunlight results in seasonal depression. Phototherapy helps with SAD by resetting the internal biological (Circadian rhythms), helping individuals sleep better and regulate their mood. Even companies, such as GE and Philips, have created phototherapeutic products to improve and regulate mood.",
      ],
    },
    {
      title: "Cosmetic Benefits",
      text: [
  ...
  ADVANTAGES: [
    {
      ...
      text: "Consistent infrared sauna sessions, especially in the middle-infrared level, can stimulate blood flow, improve muscle recovery, and decrease pain and inflammation after intense exercise.",
    },
    {
      title: "Detoxification",
      text: "Sweating is one of the body's most natural ways to eliminate toxins, making it a crucial part of detoxification. When compared to traditional Swedish saunas, infrared saunas allow you to eliminate about seven times more toxins.",
    },
    {
      title: "Pain Relief",
      text: "If you suffer from muscle aches or joint pain, infrared saunas can relive this form of inflammation by increasing circulation and relaxing your muscles.",
    },
    {
      title: "Skin Purification",
      text: "Infrared sauna technology can help purify your skin by eliminating toxins from your pores and increasing circulation, resulting in clearer, softer, and healthier-looking skin.",
    },
    {
      title: "Relaxation",
      text: "Infrared sauna therapy promotes relaxation by helping to balance your body's level of cortisol, your body's primary stress hormone. The heat generated by the sauna will also help to relax muscles and relieve tension throughout the body, allowing you to relax and de-stress.",
    },
  ],
};
