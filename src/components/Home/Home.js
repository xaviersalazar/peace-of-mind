          ...
          >
            <Card className="border-none bg-slate-100">
              <div className="card-image flex-1">
                <img
                  className="ml-4 mr-0 mt-4 mb-0 w-[84px]"
                  src={`${process.env.PUBLIC_URL}/assets/services/massage-icon.png`}
                />
              </div>
              <Card.Body className="p-4 text-left">
                <Card.Title className="text-md">Massage</Card.Title>
                <p className="text-xs font-light">
                  You will leave completely rejuvenated
                </p>
              </Card.Body>
            </Card>
            <Card className="border-none bg-slate-100">
              <div className="card-image flex-1">
                <img
                  className="ml-4 mr-0 mt-4 mb-0 w-[68px]"
                  src={`${process.env.PUBLIC_URL}/assets/services/salon-icon.png`}
                />
              </div>
              <Card.Body className="p-4 text-left">
                <Card.Title className="text-md">Salon</Card.Title>
                <p className="text-xs font-light">
                  Salon services of the highest quality
                </p>
              </Card.Body>
            </Card>
            <Card className="border-none bg-slate-100">
              <div className="card-image flex-1">
                <img
                  className="ml-4 mr-0 mt-4 mb-0 w-[128px]"
                  src={`${process.env.PUBLIC_URL}/assets/services/couples-icon.png`}
                />
              </div>

              <Card.Body className="p-4 text-left">
                <Card.Title className="text-md">Couples</Card.Title>
                <p className="text-xs font-light">
            ...
            <Card className="border-none bg-slate-100">
              <div className="card-image flex-1">
                <img
                  className="ml-4 mr-0 mt-4 mb-0 w-[92px]"
                  src={`${process.env.PUBLIC_URL}/assets/services/facials-icon.png`}
                />
              </div>

              <Card.Body className="p-4 text-left">
                <Card.Title className="text-md">Facials</Card.Title>
                <p className="text-xs font-light">
            ...
            <Card className="border-none bg-slate-100">
              <div className="card-image flex-1">
                <img
                  className="ml-4 mr-0 mt-4 mb-0 w-[84px]"
                  src={`${process.env.PUBLIC_URL}/assets/services/waxes-icon.png`}
                />
              </div>
              <Card.Body className="p-4 text-left">
                <Card.Title className="text-md">Waxing</Card.Title>
                <p className="text-xs font-light">Full service waxing</p>
              </Card.Body>
            </Card>
            <Card className="border-none bg-slate-100">
              <div className="card-image flex-1">
                <img
                  className="ml-4 mr-0 mt-4 mb-0 w-[92px]"
                  src={`${process.env.PUBLIC_URL}/assets/services/scrubs-weightloss-icon.png`}
                />
              </div>
              <Card.Body className="p-4 text-left">
            ...
            <Card className="border-none bg-slate-100">
              <div className="card-image flex-1">
                <img
                  className="ml-4 mr-0 mt-4 mb-0 w-[92px]"
                  src={`${process.env.PUBLIC_URL}/assets/services/infrared-sauna-icon.png`}
                />
              </div>
              <Card.Body className="p-4 text-left">
                <Card.Title className="text-md">Infrared Sauna</Card.Title>
                <p className="text-xs font-light">
                  Infrared light therapy to help you heal
                </p>
              </Card.Body>
            </Card>
            <Card className="border-none bg-slate-100">
              <div className="card-image flex-1">
                <img
                  className="ml-4 mr-0 mt-4 mb-0 w-[84px]"
                  src={`${process.env.PUBLIC_URL}/assets/services/oxy-bar-icon.png`}
                />
              </div>
              <Card.Body className="p-4 text-left">
                <Card.Title className="text-md">Oxygen Bar</Card.Title>
                <p className="text-xs font-light">
                  Oxygen rejuvenation for the brain
                </p>
              </Card.Body>
            </Card>
            <Card className="border-none bg-slate-100">
              <div className="card-image flex-1">
                <img
                  className="ml-4 mr-0 mt-4 mb-0 w-[64px]"
                  src={`${process.env.PUBLIC_URL}/assets/services/oxy-foot-soak-icon.png`}
                />
              </div>
              <Card.Body className="p-4 text-left">
                <Card.Title className="text-md">Oxygen Foot Soak</Card.Title>
                <p className="text-xs font-light">
                  Detox the impurities from your body
                </p>
              </Card.Body>
            </Card>
            <Card className="border-none bg-slate-100">
              <div className="card-image flex-1">
                <img
                  className="ml-4 mr-0 mt-4 mb-0 w-[64px]"
                  src={`${process.env.PUBLIC_URL}/assets/services/add-ons-icon.png`}
                />
              </div>
              <Card.Body className="p-4 text-left">
                <Card.Title className="text-md">Add-on Services</Card.Title>
                <p className="text-xs font-light">
                  Services to add onto your massages, etc
                </p>
              </Card.Body>
            </Card>
          </div>
